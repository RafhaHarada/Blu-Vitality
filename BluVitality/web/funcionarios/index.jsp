...
<div class="row">
    <div class="container">
        <ul class="tabs tabs-transparent">
            <li class="tab"><a href="#Servicos1" class="active teal-text">Acesso ao Prontuário</a></li>
            ...
            <li class="tab"><a href="#Servicos5" class="teal-text">Listagem de Pacientes</a></li>
            ...
            <li class="tab"><a href='#Servicos12' class="teal-text">Teste</a></li>
        </ul>
        <div id="Servicos1" class="col s12 container white">
            <div class="row">
                <div class="col s12">
                    <div class="row">
                        <div class="row">
                ...
                <div id="Servicos3" class="col s12 container green">Forum de Saúde Vitality


                </div>
                <div id="Servicos4" class="col s12 container yellow">Test 4
