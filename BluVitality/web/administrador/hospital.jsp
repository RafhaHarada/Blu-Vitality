...
<div class="row">
    <div class="container  center" style="margin-top: auto">
        ...
        <ul class="tabs tabs-transparent">
            ...
            <li class="tab"><a href="#hospital2" class="teal-text waves-effect">Configuração</a></li>
            <li class="tab"><a href="#hospital3" class="teal-text waves-effect">Equipamentos</a></li>
            <li class="tab"><a href="#hospital4" class="teal-text waves-effect">Funcionarios</a></li>
        ...
        <div id="hospital1" class="col s12 container">
            ...
            <div id="hospital4" class="col s12 container">
                <div class="">
