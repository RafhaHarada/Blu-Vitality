                ...
                <form class="form-group" id="testform">
                    <div class="row">
                        <div class="input-field col s12 m7">
                            ...
                            <input id="cadastro-nome-completo" type="text" class="minhaclasse" disabled="disabled" name="nome-completo">
                    ...
                    <a class="waves-effect waves-light btn" id="btn-editar"><i class="material-icons left">edit</i>button</a>
                    <a class="waves-effect waves-light btn" id="btn-cancelar"><i class="material-icons right">do_not_disturb</i>button</a>
            </form>
        </div>
        <<script>
            $("#btn-editar").click(function () {
                $(".testform").click($('.testform').removeAttr('disabled'));
            });
            $("#botao-cancelar").click(function () {
                $(".testform").click($('.testform').attr('disabled', 'disabled'));
            });
        </script>
