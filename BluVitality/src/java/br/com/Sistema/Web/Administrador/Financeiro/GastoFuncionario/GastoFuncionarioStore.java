 ...
 */
@WebServlet("/gastoFuncionario/store")
public class GastoFuncionarioStore extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        gastoFuncionario.setId(new GastoFuncionarioDAO().adicionar(gastoFuncionario));

        resp.setContentType("text/html;charset=UTF-8");
        resp.sendRedirect("/gastoFuncionario?id=" + gastoFuncionario.getId());
    }
}